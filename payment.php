		...
		<div class="col-sm-12 paymentWrapper">
			...
			<div class="col-sm-6">
				...
				<div class="col-sm-12">
					...
					<input type="text" class="input" name="cardNumber" placeholder="Enter the card number" id="cardNumber" pattern="[0-9]{16}" title="Card Number must be exactly 16 digits long and contain only numbers." required>
				...
				<div class="col-sm-12">
					...
					<input type="text" class="input" name="nameOnCard" placeholder="Enter the name of the card holder" id="nameOnCard" required="true"/>
				...
				<div class="col-sm-6">
					...
					<input type="password" class="inputSmall" name="cvv" placeholder="CVV" id="cvv" required="true"/>
					
				</div>
				
				<div class="col-sm-6">
					
					<input type="text" class="inputSmall" name="expiry" placeholder="MM/YY" id="cardExpiry" required="true"/>
